  ...
  return (
    <>
      <Box display="flex" alignItems="flex-start">
        <Avatar alt={usuario!.nombre} src={usuario!.avatar} />
        <Box sx={{ ml: 1.5, flex: 1 }} ref={ref}>
          <Box
            display="flex"
          ...
          >
            ...
            >
              <MenuUserBox sx={{ minWidth: 210 }} display="flex">
                ...
                <UserBoxText>
                  <UserBoxLabel variant="body1">{usuario!.nombre}</UserBoxLabel>
              ...
              <List sx={{ p: 1 }} component="nav">
                <ListItem button to="/user" component={NavLink}>
