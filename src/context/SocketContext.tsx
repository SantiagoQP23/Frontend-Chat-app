...
import { addMensaje, cargarUsuarios, mensajeEntregado, mensajeLeido, mensajesEntregados, nuevoMensaje, selectChat, usuarioConectado, usuarioDesconectado } from "../store/slices/chat";
...
export const SocketProvider:FC<Props> = ({children}) => {
  ...
  const { socket, online, conectarSocket, desconectarSocket} = useSocket(VITE_CHAT_BACKEND);
